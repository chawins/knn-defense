...
# class MNISTRotDataloader(Dataset):
...
#             transforms.ToTensor()
#         ])
#         self.ind = np.arange(len(dataset) // self.batch_size)
#         if shuffle:
#             self.shuffle()
#
#     def __len__(self):
...
#         begin = self.ind[idx] * self.batch_size
#         end = (self.ind[idx] + 1) * self.batch_size
#         imgs = self.dataset[begin:end]
#         rotated_imgs = [
#             self.transform(img0),
