'''Train CIFAR-10 model with NCA and AT'''
...
def main():
    ...
    # Set experiment id
    exp_id = 3
    model_name = 'adv_cifar10_nca_exp%d' % exp_id
    ...
    log = logging.getLogger('adv_cifar10_nca')
    ...
    trainloader, validloader, testloader = load_cifar10(batch_size,
                                                        ...
                                                        shuffle=True,
                                                        seed=seed)
    train_data, _, _ = load_cifar10_all(
